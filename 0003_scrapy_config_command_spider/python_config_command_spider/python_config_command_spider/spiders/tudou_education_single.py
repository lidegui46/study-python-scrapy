...
from python_config_command_spider.items.MovieItem import MoiveItem

"""
注：爬取“单个网页”数据继承父类“scrapy.Spider”,默认解析器“parse”
"""
class TudouEducationSingleSpider(scrapy.Spider):
    name = 'tudou_education_single'
    ...
    def parse(self, response):
        print("------------------------------ TudouEducationSingleSpider begin ------------------------------")
